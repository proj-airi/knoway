...
type RouteFallback struct {
	...
	// (immediately)
	PreDelay *duration.Duration `protobuf:"bytes,2,opt,name=pre_delay,json=preDelay,proto3,oneof" json:"pre_delay,omitempty"`
	// Only valid when the ongoing attempt failed occurred, default: 0s
	// (immediately)
	PostDelay *duration.Duration `protobuf:"bytes,3,opt,name=post_delay,json=postDelay,proto3,oneof" json:"post_delay,omitempty"`
	// default: 3
...
func (x *RouteFallback) GetPreDelay() *duration.Duration {
	if x != nil {
		return x.PreDelay
	}
	return nil
...
func (x *RouteFallback) GetPostDelay() *duration.Duration {
	if x != nil {
		return x.PostDelay
	}
	return nil
